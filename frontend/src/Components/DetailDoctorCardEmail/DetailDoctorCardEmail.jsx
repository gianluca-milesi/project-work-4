import style from "./DetailDoctorCardEmail.module.css";
//Hooks
...
function DetailDoctorCardEmail({ item = {} }) {
  const {
    nome,
    cognome,
    immagine,
      ...
      <div className={style.card_body}>
        <div className={style.doc_bio}>
          ...
          <div className={`${style.doc_specialization} text-sm`}>
            <p className="lg:font-normal text-lg">
        ...
        <div className={style.doc_contacts}>
          ...
          <div className="sm:flex gap-3">
            ...
            <div className="text-sm flex items-center gap-0.5">
              <FiPhone />
              <p>
                <span className="italic text-neutral-500">Telefono: </span>
                <Link
                  to="https://play-lh.googleusercontent.com/N8k1v59v30l3G4d7tEBRQZqHIMpUVyDyFzb0B4sxOwJqCBL-OsWYCT1dJaZhzNvrnr4=w240-h480-rw"
                  target="_blank"
                >
                  {telefono}
                </Link>
...
export default DetailDoctorCardEmail;
