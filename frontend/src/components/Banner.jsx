...
function Banner(){
    return(
        <div className={"container mx-auto flex justify-between items-center"} style={{backgroundColor:"var(--color-secondary)"}}>
            ...
            <Link to="/registration" className={"px-1.5 py-2.5 b-none rounded-md cursor-pointer font-bold uppercase text-white text-sm md:text-md lg:text-lg"} style={{backgroundColor:"var(--color-primary)"}}>
                <h2>unisciti</h2>
            </Link>
